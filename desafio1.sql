...
-- Create the tables structure for the database
...
INSERT INTO
    `SpotifyClone`.users (name, age, plan_id, signature_date)
VALUES
...
INSERT INTO
    SpotifyClone.albums (album, release_year, artist_id)
VALUES
    ('Envious', 1990, 1),
    ('Exuberant', 1993, 1),
...
INSERT INTO
    `SpotifyClone`.followers (user_id, following_artist)
VALUES
    (1, 1),
    (1, 4),
    (1, 3),
...
INSERT INTO
    `SpotifyClone`.songs (song, duration, album_id)
VALUES
    ('Soul For Us', 200, 1),
...
INSERT INTO
    `SpotifyClone`.historic (user_id, song_id, reprodution_date)
VALUES
